...
namespace SWWerkplaats.Configurator.SolidWorks
{
    public sealed class SolidWorksMacroExporter
    {
        ...
        private static string BuildMacro(WorkbenchModel model, string cadFolder)
        {
            ...
            sb.AppendLine("' GeneratorVersion: SWWerkplaats_CabinetFaceExplicitSketchCuts_2026_05_10");
            sb.AppendLine();
            ...
            sb.AppendLine("    swModel.SketchManager.CreateCircleByRadius faceX, hy, hx, radius");
            sb.AppendLine("End Sub");
            sb.AppendLine();
