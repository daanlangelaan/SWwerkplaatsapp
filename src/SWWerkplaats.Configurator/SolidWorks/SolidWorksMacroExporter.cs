...
namespace SWWerkplaats.Configurator.SolidWorks
{
    public sealed class SolidWorksMacroExporter
    {
        ...
        private static string BuildMacro(WorkbenchModel model, string cadFolder)
        {
            ...
            sb.AppendLine("' GeneratorVersion: SWWerkplaats_CabinetVerticalZBaseContours_2026_05_10");
            sb.AppendLine();
            ...
            sb.AppendLine("        CreateVerticalZBaseSketch swModel, x, z, toeDepth, toeHeight, holeData");
            ...
            sb.AppendLine("        Exit Sub");
            sb.AppendLine("    End If");
            sb.AppendLine("    If Not isVerticalZ Then");
            ...
            sb.AppendLine("    faceX = thickness / 2");
            sb.AppendLine("    swModel.ClearSelection2 True");
            sb.AppendLine("    ok = SelectVerticalZFacePlane(swModel, thickness, \"Gatenvlak_VerticaalZ\")");
            sb.AppendLine("    If Not ok Then Exit Sub");
            sb.AppendLine("    swModel.SketchManager.InsertSketch True");
            sb.AppendLine("    On Error Resume Next");
            sb.AppendLine("    swModel.SketchManager.AddToDB = True");
            ...
            sb.AppendLine("        fields = Split(holes(i), \";\")");
            sb.AppendLine("        If UBound(fields) >= 2 Then");
            sb.AppendLine("            CreateVerticalZFaceCircle swModel, Val(fields(0)), Val(fields(1)), Val(fields(2)) / 2, faceX");
            sb.AppendLine("            hasHoles = True");
            sb.AppendLine("        End If");
            sb.AppendLine("    Next");
            sb.AppendLine("    On Error Resume Next");
            ...
            sb.AppendLine("End Sub");
            sb.AppendLine();
            sb.AppendLine("Sub CreateVerticalZBaseSketch(swModel As Object, depth As Double, height As Double, toeDepth As Double, toeHeight As Double, holeData As String)");
            sb.AppendLine("    Dim xFront As Double");
            sb.AppendLine("    Dim xBack As Double");
            sb.AppendLine("    Dim yBottom As Double");
            sb.AppendLine("    Dim yTop As Double");
            sb.AppendLine("    Dim notchX As Double");
            sb.AppendLine("    Dim notchY As Double");
            sb.AppendLine("    xFront = -depth / 2");
            sb.AppendLine("    xBack = depth / 2");
            sb.AppendLine("    yBottom = -height / 2");
            sb.AppendLine("    yTop = height / 2");
            sb.AppendLine("    If toeDepth > 0 And toeHeight > 0 Then");
            sb.AppendLine("        notchX = xFront + toeDepth");
            sb.AppendLine("        notchY = yBottom + toeHeight");
            sb.AppendLine("        swModel.SketchManager.CreateLine notchX, yBottom, 0, xBack, yBottom, 0");
            sb.AppendLine("        swModel.SketchManager.CreateLine xBack, yBottom, 0, xBack, yTop, 0");
            sb.AppendLine("        swModel.SketchManager.CreateLine xBack, yTop, 0, xFront, yTop, 0");
            sb.AppendLine("        swModel.SketchManager.CreateLine xFront, yTop, 0, xFront, notchY, 0");
            sb.AppendLine("        swModel.SketchManager.CreateLine xFront, notchY, 0, notchX, notchY, 0");
            sb.AppendLine("        swModel.SketchManager.CreateLine notchX, notchY, 0, notchX, yBottom, 0");
            sb.AppendLine("    Else");
            sb.AppendLine("        swModel.SketchManager.CreateCenterRectangle 0, 0, 0, depth / 2, height / 2, 0");
            sb.AppendLine("    End If");
            sb.AppendLine("    CreateVerticalZBaseHoleCircles swModel, holeData");
            sb.AppendLine("End Sub");
            sb.AppendLine();
