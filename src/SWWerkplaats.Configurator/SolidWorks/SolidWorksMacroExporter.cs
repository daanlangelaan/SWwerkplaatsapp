...
namespace SWWerkplaats.Configurator.SolidWorks
{
    public sealed class SolidWorksMacroExporter
    {
        ...
        private static string BuildMacro(WorkbenchModel model, string cadFolder)
        {
            ...
            sb.AppendLine("' GeneratorVersion: SWWerkplaats_CabinetVerticalZFinalWorldContours_2026_05_11");
            sb.AppendLine();
            ...
            sb.AppendLine("    ' VERTICAL_Z wordt in eindstand getekend: dikte over X, hoogte over Y, diepte over Z.");
            ...
            sb.AppendLine("    Else");
            sb.AppendLine("        swModel.SketchManager.CreateLine 0, yBottom, zFront, 0, yBottom, zBack");
            sb.AppendLine("        swModel.SketchManager.CreateLine 0, yBottom, zBack, 0, yTop, zBack");
            sb.AppendLine("        swModel.SketchManager.CreateLine 0, yTop, zBack, 0, yTop, zFront");
            sb.AppendLine("        swModel.SketchManager.CreateLine 0, yTop, zFront, 0, yBottom, zFront");
            sb.AppendLine("    End If");
            ...
            sb.AppendLine("            If dia > 0 Then swModel.SketchManager.CreateCircleByRadius 0, Val(fields(1)), Val(fields(0)), dia / 2");
            sb.AppendLine("        End If");
            sb.AppendLine("    Next");
            sb.AppendLine("    On Error Resume Next");
            sb.AppendLine("    swModel.SketchManager.AddToDB = False");
