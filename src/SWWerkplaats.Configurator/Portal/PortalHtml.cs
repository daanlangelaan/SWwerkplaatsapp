...
<body>
  ...
  <script>
    let lastRequest=null,lastQuote=null,assemblyParts=[],rotationDeg=35,dragging=false,lastDragX=0,threePromise=null,threeApi=null,threeState=null,modalSource=null,nestingZoom=1,nestingBaseWidth=0,nestingBaseHeight=0;
