...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}html{background:var(--bg)}body{margin:0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;background:radial-gradient(circle at 20% -10%,#ffffff 0,#f5f5f7 36%,#eef1f5 100%);color:var(--ink);letter-spacing:0}
    ...
    .productOnlyMachineBase,.productOnlyRobotCell,.productOnlyMaterialCart,.productOnlySimRig,.productOnlyShippingBox{display:none}.isMachineBase .productOnlyMachineBase,.isRobotCell .productOnlyRobotCell,.isMaterialCart .productOnlyMaterialCart,.isSimRig .productOnlySimRig,.isShippingBox .productOnlyShippingBox{display:block}.isMachineBase .productOnlyCabinet,.isMachineBase .productOnlyCabinetOrCubby,.isMachineBase #primarySheetMaterialField,.isMachineBase .unitField,.isRobotCell .productOnlyCabinet,.isRobotCell .productOnlyCabinetOrCubby,.isRobotCell #primarySheetMaterialField,.isRobotCell .unitField,.isMaterialCart .productOnlyCabinet,.isMaterialCart .productOnlyCabinetOrCubby,.isMaterialCart #primarySheetMaterialField,.isMaterialCart .unitField,.isSimRig .productOnlyCabinet,.isSimRig .productOnlyCabinetOrCubby,.isSimRig #primarySheetMaterialField,.isSimRig .unitField,.isShippingBox .productOnlyCabinet,.isShippingBox .productOnlyCabinetOrCubby,.isShippingBox .productOnlyWorkbench,.isShippingBox .productOnlyWorkbenchCabinet,.isShippingBox .unitField{display:none}.shippingSourceNote{margin:10px 0 4px;padding:13px 14px;border-radius:14px;background:#fff7e8;color:#7a4b00;font-size:13px;line-height:1.5}.shippingSourceNote strong{display:block;color:#1d1d1f;margin-bottom:4px}
...
<body>
  ...
  <section class=""start"" id=""start"">
    ...
    <div class=""choices"">
      ...
      <button class=""choice"" type=""button"" onclick=""chooseProduct('materiaalwagen')"">
        <div class=""choiceArt"" aria-label=""Schematische materiaalwagen""><svg viewBox=""0 0 420 250"" role=""img"" aria-label=""Modulaire materiaalwagen met drie legborden""><g fill=""none"" stroke=""#9aa5ae"" stroke-width=""8"" stroke-linejoin=""round""><path d=""M92 60v132M328 60v132M125 45v132M355 45v132""/><path d=""M92 60l236 0 27-15-230 0zM92 116l236 0 27-15-230 0zM92 172l236 0 27-15-230 0z""/></g><g fill=""#f1f2ef"" stroke=""#c8cdd2"" stroke-width=""2""><path d=""M98 50h226l23-12H124z""/><path d=""M98 106h226l23-12H124z""/><path d=""M98 162h226l23-12H124z""/></g><g fill=""#23272b""><circle cx=""92"" cy=""207"" r=""15""/><circle cx=""328"" cy=""207"" r=""15""/><circle cx=""125"" cy=""192"" r=""13""/><circle cx=""355"" cy=""192"" r=""13""/></g><path d=""M328 60V25h27V5"" fill=""none"" stroke=""#9aa5ae"" stroke-width=""8""/></svg></div>
        <div class=""choiceImageLabel"">Materiaal- en gereedschapswagen</div>
        <h3>Modulaire materiaalwagen</h3>
        <p>Mobiel 40×40-frame met twee tot vier legbordlagen, automatisch verstevigd en voorzien van een configureerbare duwbeugel.</p>
        <span>Configureer materiaalwagen</span>
      </button>
      <button class=""choice"" type=""button"" onclick=""chooseProduct('sim_rig_4080')"">
        <div class=""choiceArt"" aria-label=""Schematische sim-racing-rig""><svg viewBox=""0 0 420 250"" role=""img"" aria-label=""Sim-racing-rig uit 40x80 profielen""><g fill=""none"" stroke=""#9aa5ae"" stroke-width=""10"" stroke-linejoin=""round""><path d=""M55 205L345 205L382 184L93 184Z""/><path d=""M132 184V72M330 184V72M132 72H330""/><path d=""M55 205L55 185M345 205L345 185""/><path d=""M76 171L178 143M76 147L178 119""/></g><g fill=""#23272b""><path d=""M118 58h28v54h-28zM316 58h28v54h-28z""/><path d=""M64 126h26l95 30-15 22z""/></g><g fill=""#d7dadd"" stroke=""#23272b"" stroke-width=""2""><rect x=""190"" y=""50"" width=""82"" height=""56"" rx=""8""/></g></svg></div>
        <div class=""choiceImageLabel"">Sim-racing-rig 40×80</div>
        <h3>Modulaire sim-rig</h3>
        <p>Verstelbaar 40×80-frame met stuurbrug, pedaalplatform en vereenvoudigde CNC-adapterplaten.</p>
        <span>Configureer sim-rig</span>
      </button>
  ...
  <main id=""app"">
    <div class=""stack"">
      <section class=""panel glass"" id=""configPanel"">
        ...
        <div class=""productOnlyMaterialCart"">
          <h3>Materiaalwagen</h3>
          <div class=""row""><div><label>Aantal legbordlagen</label><select id=""materialCartShelfCount""><option value=""2"">2 lagen</option><option value=""3"" selected>3 lagen</option><option value=""4"">4 lagen</option></select></div><div><label>Materiaal legborden</label><select id=""materialCartShelfMaterialId""></select></div></div>
          <div class=""row""><div><label>Duwbeugel</label><select id=""materialCartHandleSide""><option value=""right"">Rechterzijde</option><option value=""left"">Linkerzijde</option><option value=""none"">Zonder duwbeugel</option></select></div><div><label>Wielopstelling</label><select id=""materialCartSteeringMode""><option value=""fixed-and-swivel"">2 vast + 2 zwenkend met rem</option><option value=""four-swivel"">4 zwenkend, waarvan 2 met rem</option></select></div></div>
          <div><label>Profielen afkorten</label><select id=""materialCartProfileSawingMode""><option value=""supplier"">Op maat inkopen bij leverancier</option><option value=""inhouse"">Zelf zagen in de werkplaats</option></select></div>
          <div class=""productLock"">Frame: 40×40 · vier doorlopende hoekstaanders · vier omtrekliggers per laag · automatisch één middenligger per laag vanaf 1000 mm breedte · TechXXL D100-wielen</div>
          <div class=""calcNote"">De ingevoerde hoogte is de bovenzijde van het bovenste legbord. Een duwbeugel steekt circa 220 mm boven het blad uit. Alle lagen worden gelijkmatig verdeeld.</div>
        </div>
        <div class=""productOnlySimRig"">
          <h3>Sim-racing-rig 40×80</h3>
          <div class=""row""><div><label>Stuurbrug vanaf voorzijde frame mm</label><input id=""simRigSteeringBridgePositionMm"" type=""number"" value=""610"" min=""350"" max=""1450"" step=""10""></div><div><label>Pedaalplatform vanaf voorzijde frame mm</label><input id=""simRigPedalDeckPositionMm"" type=""number"" value=""250"" min=""180"" max=""1000"" step=""10""></div></div>
          <div class=""row""><div><label>Pedaalhoek</label><select id=""simRigPedalAngleDeg""><option value=""0"">0° vlak</option><option value=""8"">8° licht</option><option value=""12"" selected>12° standaard</option><option value=""18"">18° sportief</option><option value=""25"">25° maximaal</option></select></div><div><label>Montage stuurwielbasis</label><select id=""simRigWheelMountPattern""><option value=""csl-dd"">Fanatec CSL DD / ClubSport DD zijmontage</option><option value=""blank"">Blanco plaat voor eigen gatenpatroon</option></select></div></div>
          <div><label>Profielen afkorten</label><select id=""simRigProfileSawingMode""><option value=""supplier"">Op maat inkopen bij leverancier</option><option value=""inhouse"">Zelf zagen in de werkplaats</option></select></div>
          <div class=""productLock"">40×80-basis · twee doorlopende langsliggers · exact drie basisdwarsliggers · twee staanders · één stuurbrug · drie pedaalprofielen · zes custom platen</div>
          <div class=""calcNote"">De custom platen behouden alleen hun functie: montagevlakken, M8-profielsleuven, draaipunt en instelbereik. Decoratieve gewichtsuitsparingen uit de referentie zijn bewust weggelaten. Stuurwielbasis, pedalen en stoel zijn klantapparatuur.</div>
        </div>
...
<div class=""calcNote"">De fysiek goedgekeurde cliptong en inschuifkamer blijven ongewijzigd. Adapter V2 heeft een 38mm kern met een 6mm links/rechts gespiegelde montagevleugel. Het onderste Ø4,5-doorvoergat ligt onder de schuifbaan; het bovenste ligt 19mm zijwaarts op de vleugel. Beide krijgen een gemeten conische kopzitting Ø8,3×4,2mm voor verzonken Ø4-schroeven en liggen volledig buiten het schuifvlak. De plint krijgt uitgelijnde blinde CNC-pilotgaten Ø3×10mm. De vleugel wijst bij buitenhoeken altijd naar het midden van de plint. CAM gebruikt de Ø3mm 2-fluit carbidefrees voor gaten kleiner dan 6mm en de Ø6mm-frees voor grotere gaten, sleuven, verdiepingen en contouren.</div>
  ...
  <script>
    ...
    async function loadCatalog(){const c=await api('/api/catalog');catalogData=c;const sheetOptions=c.sheets.map(x=>`<option value=""${x.Id}"">${x.Name}</option>`).join('');$('sheetMaterialId').innerHTML=sheetOptions;$('drawerMaterialId').innerHTML=sheetOptions;$('backMaterialId').innerHTML=sheetOptions;if($('slidingDoorMaterialId'))$('slidingDoorMaterialId').innerHTML=sheetOptions;if($('materialCartShelfMaterialId'))$('materialCartShelfMaterialId').innerHTML=sheetOptions;$('profileMaterialId').innerHTML=c.profiles.map(x=>`<option value=""${x.Id}"">${x.Name}</option>`).join('');$('sheetMaterialId').value='betonplex_18';$('drawerMaterialId').value='multiplex_15';$('backMaterialId').value='multiplex_15';if($('slidingDoorMaterialId'))$('slidingDoorMaterialId').value='betonplex_12';if($('materialCartShelfMaterialId'))$('materialCartShelfMaterialId').value='hpl_10_lex';$('profileMaterialId').value='alu_profile_40x40';}
    ...
    function buildThreeParts(THREE,group,parts){
      parts.forEach(p=>{
        ...
        if(p.Shape==='swivel-caster'){addMaterialCartCaster(THREE,group,p);return;}
        ...
        const mesh=new THREE.Mesh(geo,material);mesh.position.set(p.Xmm,p.Ymm,p.Zmm);mesh.rotation.set((p.RotationXDeg||0)*Math.PI/180,(p.RotationYDeg||0)*Math.PI/180,(p.RotationZDeg||0)*Math.PI/180);if(alignmentPin)mesh.renderOrder=19;group.add(mesh);
        const edges=new THREE.LineSegments(new THREE.EdgesGeometry(geo),new THREE.LineBasicMaterial({color:0x475467,transparent:true,opacity:transparent ? .3 : .62}));edges.position.copy(mesh.position);edges.rotation.copy(mesh.rotation);group.add(edges);
    ...
    function addMaterialCartCaster(THREE,group,p){
      const technical=assemblyColorMode==='technical',steel=new THREE.MeshStandardMaterial({color:technical?0x788590:0xaeb6bc,roughness:.3,metalness:.8}),rubber=new THREE.MeshStandardMaterial({color:0x17191c,roughness:.92,metalness:0}),brake=new THREE.MeshStandardMaterial({color:0xd04d2b,roughness:.58,metalness:.08}),bottom=p.Ymm-p.SizeYmm/2,isFixed=(p.Name||'').toLowerCase().includes('vast wiel'),isBrake=(p.Name||'').toLowerCase().includes('rem');
      const wheel=new THREE.Mesh(new THREE.CylinderGeometry(50,50,36,36),rubber);wheel.rotation.x=Math.PI/2;wheel.position.set(p.Xmm,bottom+50,p.Zmm);group.add(wheel);
      const hub=new THREE.Mesh(new THREE.CylinderGeometry(11,11,39,24),steel);hub.rotation.x=Math.PI/2;hub.position.copy(wheel.position);group.add(hub);
      const forkLeft=new THREE.Mesh(new THREE.BoxGeometry(8,58,7),steel),forkRight=new THREE.Mesh(new THREE.BoxGeometry(8,58,7),steel);forkLeft.position.set(p.Xmm-23,bottom+91,p.Zmm);forkRight.position.set(p.Xmm+23,bottom+91,p.Zmm);forkLeft.rotation.z=.28;forkRight.rotation.z=-.28;group.add(forkLeft,forkRight);
      const yoke=new THREE.Mesh(new THREE.BoxGeometry(58,8,42),steel);yoke.position.set(p.Xmm,bottom+118,p.Zmm);group.add(yoke);
      if(!isFixed){const swivel=new THREE.Mesh(new THREE.CylinderGeometry(25,25,8,28),steel);swivel.position.set(p.Xmm,bottom+126,p.Zmm);group.add(swivel);}
      if(isBrake){const pedal=new THREE.Mesh(new THREE.BoxGeometry(34,7,20),brake);pedal.position.set(p.Xmm+33,bottom+92,p.Zmm);pedal.rotation.z=-.25;group.add(pedal);}
    }
    ...
    function addProfileSlotLines(THREE,group,p){
      ...
      const geometry=new THREE.BufferGeometry().setFromPoints(points),material=new THREE.LineBasicMaterial({color:assemblyColorMode==='technical'?0x3f5365:0x626b73,transparent:true,opacity:.82,depthTest:true,depthWrite:false}),lines=new THREE.LineSegments(geometry,material);if((p.RotationXDeg||0)||(p.RotationYDeg||0)||(p.RotationZDeg||0)){geometry.translate(-p.Xmm,-p.Ymm,-p.Zmm);lines.position.set(p.Xmm,p.Ymm,p.Zmm);lines.rotation.set((p.RotationXDeg||0)*Math.PI/180,(p.RotationYDeg||0)*Math.PI/180,(p.RotationZDeg||0)*Math.PI/180);}lines.renderOrder=8;group.add(lines);
    }
    ...
    syncProductUi=function(){syncBaseProductUi();const product=$('product').value,isMachineBase=product==='machinebasis',isRobotCell=product==='robotcel',isMaterialCart=product==='materiaalwagen',isSimRig=product==='sim_rig_4080',isShippingBox=product==='shipping_box';document.body.classList.toggle('isMachineBase',isMachineBase);document.body.classList.toggle('isRobotCell',isRobotCell);document.body.classList.toggle('isMaterialCart',isMaterialCart);document.body.classList.toggle('isSimRig',isSimRig);document.body.classList.toggle('isShippingBox',isShippingBox);if(isMachineBase){$('productName').textContent='Parametrische machinebasis';$('widthLabel').textContent='Buitenbreedte frame mm';$('depthLabel').textContent='Buitendiepte frame mm';$('heightLabel').textContent='Totale hoogte vanaf vloer mm';[['widthMm',1000,6000],['depthMm',600,2000],['heightMm',1000,2300]].forEach(x=>{const el=$(x[0]);el.min=x[1];el.max=x[2];el.step=10;});$('generateBtn').textContent='Genereer machineframe';}else if(isRobotCell){$('productName').textContent='Robot cel';$('widthLabel').textContent='Buitenbreedte frame mm';$('depthLabel').textContent='Buitendiepte frame mm';$('heightLabel').textContent='Werkbladhoogte mm';[['widthMm',600,6000],['depthMm',500,2000],['heightMm',650,1200]].forEach(x=>{const el=$(x[0]);el.min=x[1];el.max=x[2];el.step=10;});$('generateBtn').textContent='Genereer robot cel';}else if(isMaterialCart){$('productName').textContent='Modulaire materiaal- en gereedschapswagen';$('widthLabel').textContent='Buitenbreedte wagen mm';$('depthLabel').textContent='Buitendiepte wagen mm';$('heightLabel').textContent='Bovenzijde bovenste legbord mm';[['widthMm',600,1800],['depthMm',450,1000],['heightMm',700,1200]].forEach(x=>{const el=$(x[0]);el.min=x[1];el.max=x[2];el.step=10;});$('generateBtn').textContent='Genereer materiaalwagen';}else if(isSimRig){$('productName').textContent='Modulaire sim-racing-rig 40×80';$('widthLabel').textContent='Totale buitenbreedte rig mm';$('depthLabel').textContent='Totale framelengte mm';$('heightLabel').textContent='Bovenzijde stuurbrug mm';[['widthMm',600,800],['depthMm',1200,1800],['heightMm',550,850]].forEach(x=>{const el=$(x[0]);el.min=x[1];el.max=x[2];el.step=10;});$('generateBtn').textContent='Genereer sim-rig';}else if(isShippingBox){$('productName').textContent='Shipping box / clipkist';$('widthLabel').textContent='Binnenlengte mm';$('depthLabel').textContent='Binnenbreedte mm';$('heightLabel').textContent='Binnenhoogte mm';[['widthMm',200,6000],['depthMm',200,3000],['heightMm',200,3000]].forEach(x=>{const el=$(x[0]);el.min=x[1];el.max=x[2];el.step=1;});if($('sheetMaterialId').dataset.shippingDefaultApplied!=='1'){$('sheetMaterialId').value='osb_18';$('sheetMaterialId').dataset.shippingDefaultApplied='1';}const t=selectedSheetThickness(),ow=+$('widthMm').value+2*t,od=+$('depthMm').value+2*t,oh=+$('heightMm').value+2*t;$('shippingBoxOuterDimensions').textContent='Berekende buitenmaten: '+roundMm(ow)+' × '+roundMm(od)+' × '+roundMm(oh)+' mm bij '+roundMm(t)+' mm plaatdikte.';$('generateBtn').textContent='Genereer shipping box';}else{if($('sheetMaterialId'))delete $('sheetMaterialId').dataset.shippingDefaultApplied;['widthMm','depthMm','heightMm'].forEach(id=>{const el=$(id);el.removeAttribute('min');el.removeAttribute('max');el.removeAttribute('step');});}};
    ...
    request=function(){const value=buildShippingBoxRequest();value.shippingBoxIncludeHandles=$('shippingBoxIncludeHandles').checked;value.shippingBoxJointMode=$('shippingBoxJointMode').value;value.materialCartShelfCount=+$('materialCartShelfCount').value;value.materialCartShelfMaterialId=$('materialCartShelfMaterialId').value;value.materialCartHandleSide=$('materialCartHandleSide').value;value.materialCartSteeringMode=$('materialCartSteeringMode').value;value.simRigSteeringBridgePositionMm=+$('simRigSteeringBridgePositionMm').value;value.simRigPedalDeckPositionMm=+$('simRigPedalDeckPositionMm').value;value.simRigPedalAngleDeg=+$('simRigPedalAngleDeg').value;value.simRigWheelMountPattern=$('simRigWheelMountPattern').value;if(value.product==='materiaalwagen')value.profileSawingMode=$('materialCartProfileSawingMode').value;if(value.product==='sim_rig_4080')value.profileSawingMode=$('simRigProfileSawingMode').value;return value;};
