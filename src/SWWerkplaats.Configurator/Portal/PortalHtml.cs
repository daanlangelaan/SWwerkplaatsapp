...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}html{background:var(--bg)}body{margin:0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;background:radial-gradient(circle at 20% -10%,#ffffff 0,#f5f5f7 36%,#eef1f5 100%);color:var(--ink);letter-spacing:0}
    ...
    .brand{display:flex;align-items:center;gap:12px}.mark{width:34px;height:34px;border-radius:10px;background:linear-gradient(145deg,#111827,#485465);box-shadow:inset 0 1px 0 rgba(255,255,255,.22)}.topMeta{font-size:13px;color:var(--muted)}
    ...
    .choices{display:grid;grid-template-columns:1fr 1fr;gap:22px}.choice{border:1px solid rgba(0,0,0,.08);border-radius:26px;background:rgba(255,255,255,.82);box-shadow:var(--shadow);padding:26px;cursor:pointer;text-align:left;transition:transform .18s ease,box-shadow .18s ease,border-color .18s ease}.choice:hover{transform:translateY(-3px);border-color:rgba(0,113,227,.32);box-shadow:0 24px 70px rgba(20,24,33,.14)}
    .choiceArt{height:190px;border-radius:20px;background:linear-gradient(145deg,#fbfbfd,#e9edf3);margin-bottom:10px;display:grid;place-items:center;overflow:hidden}.choiceArt svg{width:92%;height:92%;display:block}.choiceImageLabel{text-align:center;font-size:18px;font-weight:780;margin:8px 0 22px;color:#1d1d1f}
...
<body>
  <header>
    ...
    <div class=""topMeta"">Lokale MVP voor configuratie, prijs en freeswachtrij</div>
  </header>
  ...
  <section class=""start"" id=""start"">
    ...
    <div class=""choices"">
      <button class=""choice"" type=""button"" onclick=""chooseProduct('werktafel')"">
        <div class=""choiceArt"">
          <svg viewBox=""0 0 520 210"" role=""img"" aria-label=""Voorbeeld werktafel"">
            <defs><linearGradient id=""benchTop"" x1=""0"" x2=""1""><stop offset=""0"" stop-color=""#d5ad74""/><stop offset=""1"" stop-color=""#f0d2a5""/></linearGradient></defs>
            <ellipse cx=""266"" cy=""180"" rx=""178"" ry=""18"" fill=""#dfe4eb""/>
            <g fill=""#cbd3df"" stroke=""#667085"" stroke-width=""3"">
              <path d=""M133 116 L158 111 L158 181 L133 188 Z""/>
              <path d=""M397 82 L422 78 L422 151 L397 157 Z""/>
              <path d=""M180 127 L203 122 L203 190 L180 196 Z"" opacity="".78""/>
              <path d=""M349 101 L372 97 L372 166 L349 172 Z"" opacity="".78""/>
              <path d=""M141 127 L414 88 L414 98 L141 138 Z""/>
              <path d=""M152 153 L386 119 L386 129 L152 163 Z"" opacity="".75""/>
            </g>
            <path d=""M86 76 L394 36 L462 69 L151 113 Z"" fill=""url(#benchTop)"" stroke=""#8b6f48"" stroke-width=""3""/>
            <path d=""M151 113 L462 69 L462 92 L151 137 Z"" fill=""#c99f68"" stroke=""#8b6f48"" stroke-width=""3""/>
            <path d=""M86 76 L151 113 L151 137 L86 101 Z"" fill=""#b98d57"" stroke=""#8b6f48"" stroke-width=""3""/>
            <g stroke=""#334155"" stroke-width=""2"" stroke-linecap=""round"" opacity="".75"">
              <path d=""M129 89 L138 94""/><path d=""M206 78 L215 83""/><path d=""M284 67 L293 72""/><path d=""M360 57 L369 62""/>
            </g>
          </svg>
        </div>
      ...
      <button class=""choice"" type=""button"" onclick=""chooseProduct('cabinet')"">
        <div class=""choiceArt"">
          <svg viewBox=""0 0 520 210"" role=""img"" aria-label=""Voorbeeld cabinet"">
            <ellipse cx=""260"" cy=""180"" rx=""178"" ry=""18"" fill=""#dfe4eb""/>
            <path d=""M104 52 L374 32 L440 66 L166 96 Z"" fill=""#d9b98f"" stroke=""#8b6f48"" stroke-width=""3""/>
            <path d=""M166 96 L440 66 L440 160 L166 190 Z"" fill=""#f4efe6"" stroke=""#9c8f7a"" stroke-width=""3""/>
            <path d=""M104 52 L166 96 L166 190 L104 148 Z"" fill=""#e3d8c8"" stroke=""#9c8f7a"" stroke-width=""3""/>
            <path d=""M178 164 L429 137 L429 156 L178 184 Z"" fill=""#b8a994"" stroke=""#7a6f60"" stroke-width=""2""/>
            <g stroke=""#9c8f7a"" stroke-width=""2"">
              <path d=""M232 88 L232 182""/><path d=""M300 81 L300 175""/><path d=""M368 74 L368 168""/>
              <path d=""M166 124 L440 94""/><path d=""M166 146 L440 116""/>
            </g>
            <g fill=""#fbfaf7"" stroke=""#9c8f7a"" stroke-width=""2"">
              <path d=""M182 105 L223 101 L223 122 L182 126 Z""/><path d=""M250 98 L291 94 L291 115 L250 119 Z""/>
              <path d=""M318 91 L359 87 L359 108 L318 112 Z""/><path d=""M386 84 L427 80 L427 101 L386 105 Z""/>
              <path d=""M182 129 L223 125 L223 160 L182 164 Z""/><path d=""M250 122 L291 118 L291 153 L250 157 Z""/>
              <path d=""M318 115 L359 111 L359 146 L318 150 Z""/><path d=""M386 108 L427 104 L427 139 L386 143 Z""/>
            </g>
            <g stroke=""#475467"" stroke-width=""3"" stroke-linecap=""round"">
              <path d=""M192 115 L213 113""/><path d=""M260 108 L281 106""/><path d=""M328 101 L349 99""/><path d=""M396 94 L417 92""/>
              <path d=""M193 143 L212 141""/><path d=""M261 136 L280 134""/><path d=""M329 129 L348 127""/><path d=""M397 122 L416 120""/>
            </g>
            <path d=""M111 139 L159 169 L159 190 L111 160 Z"" fill=""#c8bca9"" stroke=""#7a6f60"" stroke-width=""2""/>
          </svg>
        </div>
    ...
    <div class=""stack"">
      <section class=""panel glass"" id=""configPanel"">
        ...
        <div class=""row productOnlyCabinet"">
          <div><label>Legplanken per unit</label><input id=""defaultShelfCount"" type=""number"" value=""1"" min=""0""></div>
  ...
  <script>
    let lastRequest=null,lastQuote=null,assemblyParts=[],rotationDeg=35,dragging=false,lastDragX=0,threePromise=null,threeApi=null,threeState=null,modalSource=null;
    ...
    function chooseProduct(product){document.body.classList.add('appOn');$('product').value=product;if(product==='werktafel'){$('widthMm').value=1500;$('depthMm').value=750;$('heightMm').value=900;$('unitCount').value=1;$('defaultShelfCount').value=0;$('defaultDrawerCount').value=0;}else{$('widthMm').value=2400;$('depthMm').value=600;$('heightMm').value=900;$('unitCount').value=4;$('defaultShelfCount').value=1;$('defaultDrawerCount').value=1;}syncProductUi();quote();}
    ...
    function request(){return{product:$('product').value,widthMm:+$('widthMm').value,depthMm:+$('depthMm').value,heightMm:+$('heightMm').value,unitCount:+$('unitCount').value,sheetMaterialId:$('sheetMaterialId').value,profileMaterialId:$('profileMaterialId').value,includeBackPanel:$('includeBackPanel').checked,includeTopDrawer:$('includeTopDrawer').checked,includeAdjustableShelfHoles:$('includeAdjustableShelfHoles').checked,defaultShelfCount:+$('defaultShelfCount').value,defaultDrawerCount:+$('defaultDrawerCount').value,doorMode:$('doorMode').value,customerName:$('customerName').value,customerEmail:$('customerEmail').value,customerPhone:$('customerPhone').value,notes:$('notes').value,includeLowerShelf:$('includeLowerShelf').checked,includeMiddleShelf:$('includeMiddleShelf').checked,lowerShelfHeightMm:+$('lowerShelfHeightMm').value,middleShelfHeightMm:+$('middleShelfHeightMm').value};}
    async function loadCatalog(){const c=await api('/api/catalog');$('sheetMaterialId').innerHTML=c.sheets.map(x=>`<option value=""${x.Id}"">${x.Name}</option>`).join('');$('profileMaterialId').innerHTML=c.profiles.map(x=>`<option value=""${x.Id}"">${x.Name}</option>`).join('');$('sheetMaterialId').value='betonplex_18';$('profileMaterialId').value='alu_profile_40x40';}
    async function quote(){try{$('message').textContent='Genereren...';$('generateBtn').disabled=true;lastRequest=request();lastQuote=await api('/api/quote',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(lastRequest)});$('summary').textContent=lastQuote.Summary;$('price').textContent='EUR '+Number(lastQuote.PriceIncVat).toFixed(2)+' incl. btw';$('lead').textContent=lastQuote.LeadTime+' - excl. btw EUR '+Number(lastQuote.PriceExVat).toFixed(2);$('nestingPreview').innerHTML=lastQuote.NestingSvg;assemblyParts=lastQuote.Assembly3D||[];$('partCount').textContent=assemblyParts.length+' onderdelen';renderAssembly();renderOrthoPreview();loadThreeViewer().then(()=>{renderAssembly();renderOrthoPreview();});$('orderBtn').disabled=false;$('mailQuoteBtn').disabled=false;$('dirtyNote').textContent='Actuele configuratie gegenereerd.';$('message').textContent='Prijs klaar. Controleer preview en zet bij akkoord om naar order.';}catch(e){$('message').innerHTML='<span class=""error"">'+e.message+'</span>';}finally{$('generateBtn').disabled=false;}}
    ...
    function renderThreeAssembly(){
      ...
      const key=JSON.stringify(assemblyParts.map(p=>[p.Name,p.Kind,p.Xmm,p.Ymm,p.Zmm,p.SizeXmm,p.SizeYmm,p.SizeZmm]));
    ...
    function buildThreeParts(THREE,group){
      assemblyParts.forEach(p=>{const material=new THREE.MeshStandardMaterial({color:p.Kind==='sheet'?0xeadcc7:0xcad4e0,roughness:.58,metalness:p.Kind==='profile'?0.18:0,transparent:true,opacity:p.Kind==='sheet'?0.94:0.88});const geo=new THREE.BoxGeometry(p.SizeXmm,p.SizeYmm,p.SizeZmm);const mesh=new THREE.Mesh(geo,material);mesh.position.set(p.Xmm,p.Ymm,p.Zmm);group.add(mesh);const edges=new THREE.LineSegments(new THREE.EdgesGeometry(geo),new THREE.LineBasicMaterial({color:0x667085,transparent:true,opacity:.48}));edges.position.copy(mesh.position);group.add(edges);(p.Holes||[]).forEach(h=>{const hg=new THREE.CircleGeometry(Math.max(3,h.DiameterMm/2),18),hm=new THREE.MeshBasicMaterial({color:0x344054,transparent:true,opacity:.72,side:THREE.DoubleSide}),hole=new THREE.Mesh(hg,hm);hole.position.set(h.Xmm,h.Ymm,h.Zmm);hole.rotation.x=-Math.PI/2;group.add(hole);});});
