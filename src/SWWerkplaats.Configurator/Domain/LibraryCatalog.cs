    ...
    public static class LibraryCatalog
    {
        ...
        public static ToolDefinition DefaultEndMill(double diameterMm, double passDepthMm)
        {
            ...
            return new ToolDefinition
            {
                ...
                FeedRateMmMin = isTestedSixMillimeterFlat ? 3200 : (isSafeFourMillimeterFlat ? 2200 : 1800),
                PlungeRateMmMin = isTestedSixMillimeterFlat ? 800 : (isSafeFourMillimeterFlat ? 600 : 400),
                SpindleRpm = 18000,
