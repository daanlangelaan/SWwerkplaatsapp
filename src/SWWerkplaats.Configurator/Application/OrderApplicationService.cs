...
namespace SWWerkplaats.Configurator.Application
{
    public sealed class OrderApplicationService
    {
        ...
        public PortalOrderRecord CreateOrder(PortalQuoteRequest request)
        {
            ...
            if (output.Model.AssemblyPlacements.Count > 0) record.ProductionAreas.Add(new PortalProductionAreaSnapshot { AreaId = "assembly", Label = "Assemblage", ItemCount = output.Model.AssemblyPlacements.Count });
